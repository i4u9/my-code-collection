...
#define COLOR_INDICATOR_PATH "images/indicator.bmp"
#define COLOR_INDICATOR_OFFSET 50
#define COLOR_INDICATOR_WIDTH 100
#define COLOR_INDICATOR_HEIGHT 100
...
#define PAINT_DEFAULT_RADIUS 5

#define INTERVAL_AFTER_SAVE_MS 3000
...
struct Application
{
    ...
    SDL_FPoint offset;  //  related to image drag 'n drop functionality
    ...
    bool render_color_picker;
    SDL_FRect color_wheel_rect;
    SDL_Surface *color_wheel;
    SDL_Texture *color_wheel_texture;
    SDL_FRect color_indicator_rect;
    SDL_Surface *color_indicator;
    SDL_Texture *color_indicator_texture;
    bool color_saved_is_black;
    SDL_Color color_saved;
};
